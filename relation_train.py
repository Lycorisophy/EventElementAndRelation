...
def get_dataloader(filenames):
    ...
    train_labels, validation_labels = \
        train_test_split(input1, input2, labels,
    ...
    train_data = TensorDataset(train_input1, train_input2, train_labels)
