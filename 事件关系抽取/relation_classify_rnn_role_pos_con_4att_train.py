...
from models.rnn_role_pos_con_model import MyGruModel as MyModel
import datetime
...
def set_args(filename):
    ...
    parser.add_argument("--mymodel_save_dir",
                        default='checkpoint/relation_classify1a/',
                        type=str)
    parser.add_argument("--learning_rate",
                        default=5e-4,
                        type=float)
    parser.add_argument("--model_name",
                        default='rnn_role_pos_con_4att_model.bin',
                        type=str,
...
# 设置全局环境
try:
    args = set_args('config/relation_classify_rnn_role_pos_con_args.txt')
