...
from models.my_optimizers import Ranger, MyOpt
from sklearn.model_selection import train_test_split
from torch.utils.data import DataLoader, TensorDataset, RandomSampler
from language_model.transformers import ElectraTokenizer
from models.rnn_model import MyModel
import datetime
...
# 设置全局环境
try:
    args = get_args('config/relation_classify_rnn_args.txt')
except FileNotFoundError:
    args = set_args('config/relation_classify_rnn_args.txt')
logger = get_logger()
set_environ()
...
def main():
    ...
    # TODO(LySoY 2020年11月30日) 建议使用**args
