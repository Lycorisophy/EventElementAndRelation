...
from models.rnn_role_pos_con_model import BlackHoleModel as MyModel
import datetime
...
def set_args(filename):
    ...
    parser.add_argument("--model_name",
                        default='rnn_role_pos_con_bh_model.bin',
                        type=str,
...
# 设置全局环境
try:
    args = set_args('config/relation_classify_rnn_role_pos_con_bh_args.txt')
