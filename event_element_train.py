...
from models.element_model import ElementEmbedding as MyEmbedding
...
def mymodel_train(args, logger, train_dataloader, test_dataloader):
    ...
    for _ in trange(epochs, desc='Epochs'):
        ...
        embedding.save(os.path.join(args.mymodel_save_dir, my_time + 'embedding.bin'))
